...
document.getElementById("nav").innerHTML =
    ...
    '<li><a href="/gallery/#galleryIframe" onclick="IFrameScroll(\'/gallery/program-1.html\')">Program-1</a></li>'+
    '<li><a href="/gallery/#galleryIframe" onclick="IFrameScroll(\'/gallery/program-2.html\')">Program-2</a></li>'+
    '</ul>'+
    '</li>'+
    '</ul>'+
    '</div>'+
