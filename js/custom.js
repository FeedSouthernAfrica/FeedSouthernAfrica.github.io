...
document.getElementById("nav").innerHTML =
    ...
    '<li><a href="/gallery/program-1.html" onclick="IFrameScroll(\'/gallery/program-1.html\')" target="galleryIframe">Program-1</a></li>'+
    '<li><a href="/gallery/program-2.html" onclick="IFrameScroll(\'/gallery/program-2.html\')" target="galleryIframe">Program-2</a></li>'+
    '</ul>'+
    '</li>'+
    '</ul>'+
    '</div>'+
